                        ...
                        if (documentSnapshot.exists()) {
                            ...
                            db.collection("carts")
                                    ...
                                    .addOnSuccessListener(aVoid -> {
                                        Toast.makeText(this, "Foglalt óra növelve a kosárban!", Toast.LENGTH_SHORT).show();
                            ...
                            db.collection("carts")
                                    ...
                                    .set(cartItem)
                                    .addOnSuccessListener(aVoid -> {
                                        Toast.makeText(this, "Sikeresen a kosárba került a foglalás!", Toast.LENGTH_SHORT).show();
                                        new android.os.Handler().postDelayed(() -> {
                                            Intent intent = new Intent(ProductDetailActivity.this, ShopActivity.class);
                                            startActivity(intent);
                                            overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
